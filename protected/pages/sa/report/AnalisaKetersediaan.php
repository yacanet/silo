...
class AnalisaKetersediaan extends MainPageSA {     
    ...
    public function filterRecord ($sender,$param) {  
        $_SESSION['currentPageAnalisaKetersediaan']['bulan']=$_SESSION['ta'].'-'.$this->cmbFilterBulan->Text.'-01';
        $this->lblBulanTahun->Text=$this->TGL->tanggal('F Y',$_SESSION['currentPageAnalisaKetersediaan']['bulan']);            
		$_SESSION['currentPageAnalisaKetersediaan']['bulan']=$_SESSION['ta'].'-'.$this->cmbFilterBulan->Text.'-01';        
        $this->populateData();
	}
    ...
    public function printOut ($sender,$param) {        
        ...
        $dataReport['bulantahun']=$_SESSION['currentPageAnalisaKetersediaan']['bulan'];
